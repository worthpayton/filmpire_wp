      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item className={classes.containerSpaceAround}>
          ...
          <Typography variant="h6" align="center" gutterBottom>
            Runtime: {data?.runtime}min | Language: {data?.spoken_languages[0].name}
          </Typography>
        </Grid>
          ...
          <div className={classes.buttonsContainer}>
            <Grid item xs={12} sm={6} className={classes.buttonsContainer}>
              <ButtonGroup size="small" varient="outlined">
                ...
                <Button target="_blank" rel="noopener noreferrer" href={`https://www.imdb/title/${data?.imdb_id}`} endIcon={<MovieIcon />}>IMDB</Button>
                <Button rel="noopener noreferrer" onClick={() => setOpen(true)} href="#" endIcon={<Theaters />}>Trailer</Button>
              </ButtonGroup>
            </Grid>
            <Grid item xs={12} sm={6} className={classes.buttonsContainer}>
